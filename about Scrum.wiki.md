...
## Contributing
If you have suggestions or notice any errors, you can [open an issue on GitHub](https://github.com/lucafrance/scrum.wiki-vault/issues) or [write to me](https://lucaf.eu).
## License
...
Each statement has a source. Non-obvious interpretations of the Scrum Guide without a source are not included.
