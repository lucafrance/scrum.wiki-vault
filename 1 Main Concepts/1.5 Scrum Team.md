...
aliases:
  - Scrum Teams
---
The [[1.5 Scrum Team|Scrum Team]] is "the fundamental unit of [[1.1 Scrum framework|Scrum]]", "a cohesive unit of professionals [[1.4 Scrum Values|focused]] on one objective at a time, the [[Product Goal]]"[^scrum-guide-2020]. The Scrum Team is "structured [...] by the [[organization]]"[^scrum-guide-2020] and consists of one [[Product Owner]], one [[Scrum Master]], multiple [[Developers]][^scrum-team-definition].

[^scrum-team-definition]: "The Scrum Team consists of one Scrum Master, one Product Owner, and Developers."[^scrum-guide-2020]

The [[1.5 Scrum Team|Scrum Team]] is accountable for creating at least one [[Increment]] for each [[Sprint]][^increment-sprint-accountability]. The [[1.5 Scrum Team|Scrum Team]] is responsible for all product-related activities[^scrum-team-responsibility].
...
The [[1.2 Scrum Guide|Scrum Guide]] recommends small Scrum Team sizes of 10 people or less for better communication and productivity[^small-scrum-teams]. The Scrum Team should also be large enough "complete significant work within a [[Sprint]]", as it is still accountable for creating an [[Increment]][^scrum-guide-2020].
