The Sprint Retrospective is the last event of the [[3.1 Sprint|Sprint]] and concludes it. With the end of the Sprint Retrospective, the next [[3.1 Sprint|Sprint]] starts[^a-new-sprint-starts].
