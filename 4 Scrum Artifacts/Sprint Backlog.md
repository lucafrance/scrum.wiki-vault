...
The [[Scrum Team]] creates the Sprint Backlog during the [[Sprint Planning]][^sprint-plan-initiates]. The [[Developers]] are accountable for its creation[^devs-accountable]. The Sprint Backlog may include improvements identified in the previous [[Sprint Retrospective]].
